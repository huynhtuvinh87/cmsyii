...
<?php // Yii::app()->clientScript->registerCssFile(Yii::app()->themeManager->baseUrl . '/css/bootstrap.css', 'screen'); ?>
        ...
        <?php Yii::app()->clientScript->registerScriptFile(Yii::app()->themeManager->baseUrl . '/scripts/init.js', CClientScript::POS_END); ?>
        <?php Yii::app()->clientScript->registerScriptFile(Yii::app()->themeManager->baseUrl . '/scripts/upload.js', CClientScript::POS_END); ?>
            ...
            <div id="sidebar">
                <div id="sidebar-wrapper"> <!-- Sidebar with logo and menu -->
                    ...
                    <div id="profile-links">
                        <?php echo Yii::t('adminglobal', 'Hello,'); ?>
                        <a href="<?php echo $this->createUrl('members/edituser', array('id' => intval(Yii::app()->user->id))); ?>" title="<?php echo Yii::t('adminglobal', 'Edit your profile'); ?>"><?php echo Yii::app()->user->name; ?></a>, <?php echo Yii::t('adminglobal', 'You have'); ?> <a href="#messages" rel="modal" title="<?php echo Yii::t('adminglobal', '{n} Messages', array('{n}' => 0)); ?>"><?php echo Yii::t('adminglobal', '{n} Messages', array('{n}' => 0)); ?></a><br />
                        <br />
                        <a href="<?php echo Yii::app()->urlManager->createUrl('site/index/index'); ?>" target='_blank' title="<?php echo Yii::t('adminglobal', 'View the Site'); ?>"><?php echo Yii::t('adminglobal', 'View the Site'); ?></a> | 
                        <a href="<?php echo Yii::app()->urlManager->createUrl('site/logout/index'); ?>" title="<?php echo Yii::t('adminglobal', 'Sign Out'); ?>"><?php echo Yii::t('adminglobal', 'Sign Out'); ?></a>
                    </div>        
