...
class CustompagesController extends AdminBaseController {
    ...
    public function init() {
        ...
        $this->breadcrumbs['Custom Pages'] = array('custompages/index');
    ...
    public function actionIndex() {
        ...
        if (isset($_POST['bulkoperations']) && $_POST['bulkoperations'] != '') {
            ...
            if (!Yii::app()->user->checkAccess('op_custompages_managepages')) {
                throw new CHttpException(403, 'Sorry, You don\'t have the required permissions to enter this section');
            }
            ...
            if (isset($_POST['record']) && count($_POST['record'])) {
                ...
                switch ($_POST['bulkoperations']) {
                    case 'bulkdelete':
                        ...
                        // Done
                        Yii::app()->user->setFlash('success', '{count} pages deleted.', array('{count}' => $records));
                        break;
                    ...
                    case 'bulkapprove':
                        ...
                        // Done
                        Yii::app()->user->setFlash('success', '{count} pages approved.', array('{count}' => $records));
                        break;
                    ...
                    case 'bulkunapprove':
                        ...
                        // Done
                        Yii::app()->user->setFlash('success', '{count} pages Un-Approved.', array('{count}' => $records));
                        break;
    ...
    public function actionaddpage() {
        ...
        if (isset($_POST['CustomPages'])) {
            if (isset($_POST['submit'])) {
                ...
                if ($model->save()) {
                    Yii::app()->user->setFlash('success', 'Page Added.');
        ...
        $this->breadcrumbs['Adding Custom Page'] = '';
        $this->pageTitle[] = 'Adding Custom Page';

        // Display form
        $this->render('page_form', array('roles' => $_roles, 'model' => $model, 'label' => 'Adding Custom Page'));
    }
