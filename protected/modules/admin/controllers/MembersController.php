...
class MembersController extends AdminBaseController {
    ...
    public function init() {
        ...
        $this->breadcrumbs['Members'] = array('members/index');
    ...
    public function actionadduser() {
        ...
        $this->breadcrumbs['Adding User'] = '';
        $this->pageTitle[] = 'Adding User';

        // Display form
        $this->render('user_form', array('items_selected' => $items_selected, 'items' => $items, 'model' => $model, 'label' => 'Adding User'));
    }
