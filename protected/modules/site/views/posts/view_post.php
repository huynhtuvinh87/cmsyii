    ...
    <div id="contentbig">
        ...
        $this->widget('CStarRating', array(
            ...
            'callback' => '
				        ...
				        $.ajax({
				            type: "POST",
				            url: "' . $this->createUrl('posts/rating') . '",
        ...
        <?php if (Posts::model()->canEditPost($model)): ?>
            <?php echo CHtml::link(CHtml::image(Yii::app()->themeManager->baseUrl . '/images/icons/pencil.png'), array('/' . Yii::app()->language . '/posts/edit/' . $model->id, 'lang' => FALSE)); ?>
        <?php endif; ?>	

        <?php if (Yii::app()->user->checkAccess('op_posts_manage')): ?>

            <?php if ($model->status): ?>
                <?php echo CHtml::link(CHtml::image(Yii::app()->themeManager->baseUrl . '/images/icons/cross_circle.png'), array('/' . Yii::app()->language . '/posts/toggle/' . $model->id, 'lang' => FALSE)); ?>
            <?php else: ?>
                <?php echo CHtml::link(CHtml::image(Yii::app()->themeManager->baseUrl . '/images/icons/tick_circle.png'), array('/' . Yii::app()->language . '/posts/toggle/' . $model->id, 'lang' => FALSE)); ?>
            <?php endif; ?>	
        ...
        <div id='pageoptions'>
            <ul>
                ...
                <li><?php echo CHtml::link(Yii::t('global', 'PDF'), array('/' . Yii::app()->language . '/posts/pdf/' . $model->id, 'lang' => FALSE)); ?></li>
                <li><?php echo CHtml::link(Yii::t('global', 'Word'), array('/' . Yii::app()->language . '/posts/word/' . $model->id, 'lang' => FALSE)); ?></li>
                <li><?php echo CHtml::link(Yii::t('global', 'Text'), array('/' . Yii::app()->language . '/posts/text/' . $model->id, 'lang' => FALSE)); ?></li>
            </ul>
        </div>

        <div id='sharingoptions'>
            <?php echo $facebook->showLike(Yii::app()->createAbsoluteUrl('/posts/view/' . $model->alias, array('lang' => false))); ?>
            ...
            <?php if (count($comments)): ?>
                <?php foreach ($comments as $comment): ?>
                    <li <?php if ($comment->visible == 0): ?>style='background-color:#FFCECE;'<?php endif; ?>>
                        ...
                        <span class='commentspan'><?php echo CHtml::link('#' . $comment->id, array('/posts/view/' . $model->alias, '#' => 'comment' . $comment->id, 'lang' => false)); ?></span>
                        ...
                        <?php if (Yii::app()->user->checkAccess('op_tutorials_comments')): ?>
                            <?php echo CHtml::link(CHtml::image(Yii::app()->themeManager->baseUrl . '/images/' . ($comment->visible ? 'cross_circle' : 'tick_circle') . '.png'), array('/' . Yii::app()->language . '/posts/status/' . $model->id, 'lang' => FALSE), array('class' => 'tooltip', 'title' => Yii::t('tutorials', 'Toggle comment status!'))); ?>
                        <?php endif; ?>
                    </li>
                <?php endforeach; ?>	
            <?php else: ?>	
